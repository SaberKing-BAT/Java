...
<div class="x-body">
    ...
    <xblock>
        <button class="layui-btn" onclick="person_add('添加信息','${pageContext.request.contextPath}/goAddPinKun','800','500')"><i class="layui-icon">&#xe608;</i>添加</button>
...
<script>
    ...
    function getList(pageNo,pageSize){
        $.ajax({
            type: 'get',
            url: "${pageContext.request.contextPath}/pinKunList",
            cache: false,
            data:{
                pageNo:pageNo,
                pageSize:pageSize
    ...
    function showList(data){
        ...
        for(var i in data){
            ...
            tableHtml += "<tr>";
            tableHtml += "<td>"+" <input type='checkbox' value="+data[i].pid+" name='checkbox1' id='resident_id'>" + "</td>";
            ...
            tableHtml +=  " <td class='td-manage'>"
                +"<a title='修改' href='javascript:;' onclick='person_look(&quot;修改&quot; ,&quot;goUpdatePinKun&quot;, "+data[i].pid+",&quot;400&quot;,&quot;500&quot;)' class='ml-5' style='text-decoration:none'>"
    ...
    function delAll () {
        layer.confirm('确认要删除吗？',function(){
            ...
            if (checkedList.length==0){
                ...
                $.ajax({
                    type:"post",
                    url: " ${pageContext.request.contextPath}/delPinKun",
                    data:{pids:wids},
                    dataType: "text",
                    success:function (data) {
    ...
    $("#sousuo").click(function() {
        $.ajax({
            type: 'get',
            url: "${pageContext.request.contextPath}/findIfPinKun",
            cache: false,
