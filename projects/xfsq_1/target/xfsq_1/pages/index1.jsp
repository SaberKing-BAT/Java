            ...
            <ul class="layui-nav layui-nav-tree site-demo-nav" lay-filter="side">
                ...
                <li class="layui-nav-item">
                    <a class="javascript:;" href="javascript:;">
                        <i class="layui-icon" style="top: 3px;">&#xe629;</i><cite>居民管理</cite>
                    </a>
                    <dl class="layui-nav-child">
                        <dd class="">
                        <dd class="">
                            <a href="javascript:;" _href="${pageContext.request.contextPath}/goResident">
                                <i class="layui-icon"></i><cite>居民信息管理</cite>
                            </a>
                        </dd>
                        </dd>
                        <dd class="">
                        <dd class="">
                            <a href="javascript:;" _href="${pageContext.request.contextPath}/goResidentStatistical">
                                <i class="layui-icon"></i><cite>居民信息统计</cite>
                            </a>
                        </dd>
                        </dd>
                    </dl>
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd class="">
                        <dd class="">
                            <a href="javascript:;" _href="${pageContext.request.contextPath}/goWuyebx">
                                <i class="layui-icon"></i><cite>报修管理</cite>
                            </a>
                        </dd>
                        </dd>
                    </dl>
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd class="">
                        <dd class="">
                            <a href="javascript:;" _href="${pageContext.request.contextPath}/goGongGaoMain">
                                <i class="layui-icon"></i><cite>发布公告</cite>
                            </a>
                        </dd>
                        <dd class="">
                        <dd class="">
                            <a href="javascript:;" _href="${pageContext.request.contextPath}/goGongZry">
                                <i class="layui-icon"></i><cite>小区工作者信息管理</cite>
                            </a>
                        </dd>
                        </dd>
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd class="">
                            <a href="javascript:;" _href="${pageContext.request.contextPath}/goActiveInfo">
                                <i class="layui-icon"></i><cite>活动组织</cite>
                            </a>
                        </dd>
                        </dd>
                        <dd class="">
                        <dd class="">
                            <a href="javascript:;" _href="${pageContext.request.contextPath}/goActiveMan">
                                <i class="layui-icon"></i><cite>参与人员</cite>
                            </a>
                        </dd>
                        </dd>
                    </dl>
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd class="">
                        <dd class="">
                            <a href="javascript:;" _href="${pageContext.request.contextPath}/goMain">
                                <i class="layui-icon"></i><cite>贫困人员信息管理</cite>
                            </a>
                        </dd>
                        </dd>
                    </dl>
    ...
    <div class="layui-tab layui-tab-card site-demo-title x-main" lay-filter="x-tab" lay-allowclose="true">
        ...
        <div class="layui-tab-content site-demo site-demo-body">
            <div class="layui-tab-item layui-show">
                <iframe frameborder="0" src="${pageContext.request.contextPath}/goResidentStatistical" class="x-iframe"></iframe>
            </div>
        </div>
    </div>
