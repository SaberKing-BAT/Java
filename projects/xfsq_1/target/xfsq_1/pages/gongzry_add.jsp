...
<div class="x-body">
    <form class="layui-form layui-form-pane">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <select lay-verify="required" name="gsex">
            ...
            <div class="layui-input-block">
                <select lay-verify="required" name="gtype">
                    <option value="卫生工作者">卫生工作者</option>
                    <option value="安保工作者">安保工作者</option>
                    <option value="物业工作者">物业工作者</option>
